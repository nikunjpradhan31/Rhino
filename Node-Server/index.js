...
mongoose.connect(uri, {
    useNewUrlParser: true,useUnifiedTopology: true}).then(()=>console.log("Mongoose Database connected")).catch((error) => console.log("Mongoose Database connection failed:" , error.message));
